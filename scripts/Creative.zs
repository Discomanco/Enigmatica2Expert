...
# Ultimate Ingot
	...
	<plustic:osgloglasingot>,<plustic:osmiridiumingot>,<plustic:mirioningot>,<nuclearcraft:ingot_oxide:1>,
	<enderio:item_material:72>,<industrialforegoing:pink_slime_ingot>,<redstonearsenal:material:32>,<twilightforest:ironwood_ingot>,
...
# Mekanism Creative Tank 
	...
	[<thermalexpansion:tank>.withTag({Fluid: {FluidName: "tree_oil", Amount: 32000}}), benitoite, megaDrum, ultCatalyst, <draconicevolution:chaotic_core>, ultCatalyst, megaDrum, benitoite, <thermalexpansion:tank>.withTag({Fluid: {FluidName: "corium", Amount: 32000}})], 
...
# Storage Drawers Unlimited Withdrawel Upgrade
	...
	[ultCatalyst, draconicChest, creativeEssence, <enderio:block_cap_bank>.anyDamage(), <ore:ingotInfinity>, <ic2:te:86>, creativeEssence, draconicChest, ultCatalyst], 
	[anglesite, <extracells:storage.component:3>, benitoite, <environmentaltech:solar_cont_6>, twilightForestMasterTrophy, <environmentaltech:solar_cont_6>, benitoite, <extracells:storage.component:3>, anglesite], 
...
# Creative Wireless Crafting Terminal
	...
	<wct:wct_creative>, 
	[<wct:wct>.withTag({}),<enderio:block_cap_bank>.anyDamage()]);
